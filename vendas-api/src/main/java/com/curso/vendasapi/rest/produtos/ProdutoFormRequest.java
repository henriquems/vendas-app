package com.curso.vendasapi.rest.produtos;
...
public class ProdutoFormRequest {
	...
	public Produto toModel() {
		return new Produto(id, sku, descricao, nome, preco);
	}
	
	public static ProdutoFormRequest fromModel(Produto produto) {
		return new ProdutoFormRequest(produto.getId(), produto.getDescricao(), 
				produto.getNome(), produto.getPreco(), produto.getSku(), produto.getDataCadastro());
	}
